    ...
    <>
      ...
      <div className="d-flex justify-content-around mb-4">
        <Card style={{ "width": "18rem" }}>
          <Card.Img variant="top" data-src={`holder.js/300x200`} alt="User profile" width="300" height="200" />
          <Card.Body>
            ...
            {user &&
              (
                <>
                  ...
                  <Card.Text className="mb-3">Id: {user.id}</Card.Text>
                </>
              )}
          </Card.Body>
        </Card>
      ...
      <div className="d-flex flex-wrap justify-items-center gap-3 justify-center mb-4">
        <Card style={{ "width": "12rem" }} className="items-center hover:cursor-pointer" onClick={() => navigate('/delivery/ebay')}>
          <Card.Body>
            <Card.Text>
              <SiEbay size="4em" />
            </Card.Text>
        ...
        <Card style={{ "width": "12rem" }} className="items-center hover:cursor-pointer" onClick={() => navigate('/delivery/ups')}>
          <Card.Body>
            <Card.Text>
              <SiUps size="4em" />
            </Card.Text>
